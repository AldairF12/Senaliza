...
public class TPApplication {
    ...
    public CommandLineRunner mappingDemo(
        ...
        return args -> {
            ...
            Exercise exercise1=exerciseRepository.save(new Exercise(Long.valueOf(0), "Avanzado", "Completar", "¿Q1?",
                    "sin comentarios",null,null,lesson1 ));
            Exercise exercise2=exerciseRepository.save(new Exercise(Long.valueOf(0), "Medio", "Marcar", "¿Q2?",
                    "sin comentarios",null,null,lesson2 ));
            Exercise exercise3=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Marcar", "¿Q3?",
                    "sin comentarios",null,null,lesson3));
            Exercise exercise4=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Completar", "¿Q4?",
                    "sin comentarios",null,null,lesson1));
            Exercise exercise5=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Completar", "¿Q5?",
                    "sin comentarios",null,null,lesson1));
            Exercise exercise6=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Completar", "¿Q6?",
                    "sin comentarios",null,null,lesson3));
            Exercise exercise7=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Completar", "¿Q7?",
                    "sin comentarios",null,null,lesson3));
            Exercise exercise8=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Completar", "¿Q8?",
                    "sin comentarios",null,null,lesson3));
            Exercise exercise9=exerciseRepository.save(new Exercise(Long.valueOf(0), "Basico", "Completar", "¿Q9?",
                    "sin comentarios",null,null,lesson3));

            ExerciseImage exerciseImage1=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"Boca",false,image2, exercise1));
            ExerciseImage exerciseImage2=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",false,image1, exercise2));
            ExerciseImage exerciseImage3=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",false,image2, exercise2));
            ExerciseImage exerciseImage4=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",true,image3, exercise2));
            ExerciseImage exerciseImage5=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",true,image1, exercise3));
            ExerciseImage exerciseImage6=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",false,image2, exercise3));
            ExerciseImage exerciseImage7=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",false,image3, exercise3));
            ExerciseImage exerciseImage8=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",false,image3, exercise6));
            ExerciseImage exerciseImage9=exerciseImageRepository.save(new ExerciseImage(Long.valueOf(0),"",false,image3, exercise4));
            ...
            StudentExercise studentExercise26=studentExerciseRepository.save(new StudentExercise(Long.valueOf(0), new Date(), null ,exercise6, student5));
